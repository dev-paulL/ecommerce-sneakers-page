...
export default function ProductImages({ currentProduct }) {
  ...
  return (
    <>
      ...
      <motion.div initial={{ opacity: 0}} animate={{opacity: 100}} transition={{duration: 0.5, delay:1}} className="w-full relative lg:static max-h-[25rem] items-center flex overflow-hidden md:max-h-[35rem] lg:gap-3 lg:max-h-max lg:flex-col lg:col-start-1 ">
